...
const briefSections: Section[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 's_main', text: 'Anh/chị cần những không gian nào trong nhà?', type: 'textarea', hint: 'Mô tả tổng quát các không gian bạn mong muốn.' },
      { id: 's_gara', text: 'Gara có cần không? Bao nhiêu xe? (ô tô, xe máy?)', type: 'text' },
      { id: 's_front_yard', text: 'Sân trước có cần rộng không? Có để xe / cảnh quan?', type: 'text' },
      { id: 's_living', text: 'Phòng khách có thường xuyên tiếp khách không? Quy mô bao nhiêu người?', type: 'text' },
      { id: 's_kitchen', text: 'Bếp + ăn: có tách bếp ướt – bếp khô không? Có cần đảo bếp?', type: 'text' },
      { id: 's_altar', text: 'Có cần phòng thờ riêng không hay kết hợp?', type: 'text' },
      { id: 's_bedrooms', text: 'Tổng số phòng ngủ? Có ưu tiên tầng trệt không?', type: 'text' },
      { id: 's_master', text: 'Phòng ngủ master có cần gì đặc biệt (WC riêng, thay đồ…)?', type: 'textarea' },
      { id: 's_wc', text: 'Cần bao nhiêu WC? Có WC riêng từng phòng không?', type: 'text' },
      { id: 's_laundry', text: 'Khu giặt phơi: muốn kín hay ngoài trời?', type: 'text' },
      { id: 's_elevator', text: 'Có cần thang máy không? (dự phòng hay lắp luôn?)', type: 'text' },
      { id: 's_extra_pool', text: 'Có cần: hồ bơi / gym / spa không?', type: 'text' },
      { id: 's_extra_ent', text: 'Có phòng giải trí riêng (xem phim, nghe nhạc)?', type: 'text' },
      { id: 's_extra_work', text: 'Có phòng làm việc / đọc sách riêng?', type: 'text' },
      { id: 's_extra_storage', text: 'Có cần kho chứa đồ không?', type: 'text' },
      { id: 's_extra_balcony', text: 'Có cần ban công / sân thượng rộng để chill / trồng cây?', type: 'text' },
